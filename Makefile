...
# quay.io/acmenezes/nsm-operator-bundle:$VERSION and quay.io/acmenezes/nsm-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/acmenezes/nsm-operator
...
IMG ?= quay.io/acmenezes/nsm-operator:v0.0.3-4
...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	$(CONTROLLER_GEN) rbac:roleName=nsm-operator-role crd webhook paths="./..." output:crd:artifacts:config=config/crd/bases
