				...
				Spec: corev1.PodSpec{
					...
					Containers: []corev1.Container{{
						...
						Env: []corev1.EnvVar{
							...
							{Name: "NSM_CONTAINER_IMAGES", Value: "ghcr.io/networkservicemesh/ci/cmd-nsc:de694f9"},
							{Name: "NSM_INIT_CONTAINER_IMAGES", Value: "ghcr.io/networkservicemesh/ci/cmd-nsc-init:6661f6b"},
							// {Name: "NSM_CONTAINER_IMAGES", Value: "ghcr.io/networkservicemesh/ci/cmd-nsc:" + nsm.Spec.Version},
							// {Name: "NSM_INIT_CONTAINER_IMAGES", Value: "ghcr.io/networkservicemesh/ci/cmd-nsc-init:" + nsm.Spec.Version},
