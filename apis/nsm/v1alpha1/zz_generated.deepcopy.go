...
func (in *ForwardingPlane) DeepCopyInto(out *ForwardingPlane) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ForwardingPlane.
func (in *ForwardingPlane) DeepCopy() *ForwardingPlane {
	if in == nil {
		return nil
	}
	out := new(ForwardingPlane)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NSMSpec) DeepCopyInto(out *NSMSpec) {
	*out = *in
	if in.ForwardingPlanes != nil {
		in, out := &in.ForwardingPlanes, &out.ForwardingPlanes
		*out = make([]ForwardingPlane, len(*in))
		copy(*out, *in)
	}
}
